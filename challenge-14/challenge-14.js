...
var operation = justMod2Or3.reduce(function(item, atual) {
  return (item + 1) * atual;
},0)
...
*/
console.log( '\nOperation 2:' );
var operationInversed = justMod2Or3.reduceRight(function(item, atual) {
  return (item + 1) * atual;
}, 0)

console.log(operationInversed);
...
var reduceP = name.reduce(function(item, atual) {
  return item + 'P' + atual
}, '')
...
*/
console.log( '\nInversed Name:' );
var inversedName = name.reduceRight(function(item, atual) {
  return item + atual;
})
